      ...
      <section className="container mx-auto px-4 py-12">
        ...
        <div className="mt-8 space-y-6">
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
            {showAddedFeedback && (
              <div className="mb-4 flex items-center gap-2 rounded-lg border border-green-200 bg-green-50 px-4 py-3 text-sm font-semibold text-green-800 shadow-sm animate-in fade-in slide-in-bottom-2 duration-300">
